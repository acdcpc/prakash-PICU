...
export const DRUGS = [
  ...
  { name: 'Gentamicin', letter: 'G', dose: 2.5, unit: 'mg/kg/dose', max: 160, route: 'IV/IM', frequency: 'Interval and duration must follow local protocol', indication: 'Serious susceptible bacterial infection', renal: 'Mandatory interval adjustment and therapeutic drug monitoring.', dialysis: 'Use dialysis-specific dosing and levels.', reference: 'teddy-bear' },
...
export const SCORE_DEFINITIONS = {
  'COMFORT-B': { title: 'COMFORT-B Scale', range: '6–30', interpretation: 'Higher scores indicate greater distress; use local threshold and serial trend.', items: ['Alertness', 'Calmness/agitation', 'Respiratory response', 'Physical movement', 'Muscle tone', 'Facial tension'], reference: 'sccm-pandem' },
  ...
  PSSS: { title: 'Pediatric Sedation State Scale', range: '1–5', interpretation: 'Record the observed sedation state and target range defined by the care team.', items: ['Arousal', 'Response to stimulation', 'Movement', 'Airway/respiratory concern'], reference: 'sccm-pandem' },
  SBS: { title: 'State Behavioral Scale', range: '-2 to +2', interpretation: 'Record the best-fit behavioral state and reassess after intervention.', items: ['Awakening', 'Attention', 'Tolerance of care', 'Consolability'], reference: 'sccm-pandem' },
  RASS: { title: 'Richmond Agitation–Sedation Scale', range: '+4 to -5', interpretation: 'Positive values indicate agitation; negative values indicate deeper sedation.', items: ['Combative/agitated', 'Restless/anxious', 'Alert/calm', 'Response to voice', 'Response to physical stimulation', 'No response'], reference: 'sccm-pandem' },
