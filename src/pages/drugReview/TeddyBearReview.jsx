...
export default function TeddyBearReview() {
  ...
  const filtered = useMemo(() => records.filter((item) => item.name.toLowerCase().includes(query.toLowerCase())), [query, records]);
  ...
  const saveReview = async () => {
    ...
    const nextStatus = selectedDraft.verified ? 'approved' : 'in-review';
